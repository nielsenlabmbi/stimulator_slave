...
Pstate.param{13} = {'s_duty'      'float'   0.5       0                ''};
Pstate.param{14} = {'t_period'    'int'       20       0                'frames'};

Pstate.param{15} = {'contrast2'    'float'     10       0                '%'};
Pstate.param{16} = {'ori2'         'int'        90       0                'deg'};
Pstate.param{17} = {'phase2'         'float'        0       0                'deg'};
Pstate.param{18} = {'s_freq2'      'float'      1      -1                 'cyc/deg'};
Pstate.param{19} = {'s_duty2'      'float'   0.5       0                ''};

Pstate.param{20} = {'lum_intersect'      'float'   0       0                ''};
