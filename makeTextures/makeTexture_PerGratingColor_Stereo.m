...
camp(1)=1/2*(P.redgain-P.redbase);
coff(1)=1/2*(P.redgain+P.redbase);

camp(2)=1/2*(P.greengain-P.greenbase);
coff(2)=1/2*(P.greengain+P.greenbase);

camp(3)=1/2*(P.bluegain-P.bluebase);
coff(3)=1/2*(P.bluegain+P.bluebase);
