function makeTexture_CounterBar

%make counterphasing square or sine weave grating
...
%generate counterphase grating
grating2 = cos(sdom+pi);
...
Gtxtr(2) = Screen('MakeTexture',screenPTR, grating2,[],[],2);
