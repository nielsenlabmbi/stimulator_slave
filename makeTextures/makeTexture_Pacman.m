...
%%%generate coordinates for Pasupathy & Connor pacman-like V4 stimuli
...
if P.sharp == 0 %contours are smooth
    %make contour:
...
else %contours are sharp
    % X and Y coordinates of the points defining the polygon, centred on the
