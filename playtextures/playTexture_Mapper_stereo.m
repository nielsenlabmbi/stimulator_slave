function playTexture_Mapper_stereo
...
symbList = {'ori','width','length','barColor','background','visible', 'LorR'};
valdom{1} = 0:15:359;
...
state.valId = [1 8 15 1 1 2 1];  %Current index for each value domain
state.symId = 1;  %Current symbol index

%shorthand index
vID=6; %visible
sterID=7; %which screen
